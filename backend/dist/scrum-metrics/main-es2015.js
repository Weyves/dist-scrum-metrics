...
module.exports = "<mat-toolbar color=\"primary\">\n    <div>\n        <button mat-icon-button (click)=\"onToggleSidenav()\" matTooltip=\"Open the menu.\">\n            <mat-icon>menu</mat-icon>\n        </button>\n    </div>\n    <div fxHide.xs>\n      <h1 id=\"project-name\" matTooltip=\"The project you're currently on.\">No open project</h1>\n    </div>\n    <div fxFlex fxLayout fxLayoutAlign=\"end\">\n      <img src=\"../../../assets/img/stockprofile.png\" alt=\"user-photo\" class=\"user-photo\" matTooltip=\"Yep. That's you!\" (click)=\"openProfile()\">\n      <h1 class=\"user-name\" matTooltip=\"That should be you. Right?\" (click)=\"openProfile()\">{{name.fullname}}</h1>\n      <button mat-icon-button>\n          <mat-icon id=\"settings-icon\" matTooltip=\"Change user settings\">settings</mat-icon>\n      </button>\n    </div>\n</mat-toolbar>\n"
...
module.exports = "<div id=\"fulldialog\">\n  <form (submit)=\"saveProfile(profileForm)\" #profileForm=\"ngForm\">\n  <div fxLayout=\"row\" fxLayoutAlign=\"center center\" id=\"title-div\">\n    <h1>My Profile</h1>\n    <div fxFlex fxLayout fxLayoutAlign=\"end\">\n      <button mat-raised-button color=\"primary\" (click)=\"onNoClick()\">X</button>\n    </div>\n  </div>\n  <div fxLayout=\"row\" fxLayoutAlign=\"center center\">\n    <h4 id=\"usernameh4\">{{user.name}}</h4>\n  </div>\n  <div mat-dialog-content>\n    <div fxLayout=\"row\">\n      <div fxLayout=\"column\">\n        <img [src]=\"url\" alt=\"user-pic\" id=\"user-pic\">\n        <div fxLayoutAlign=\"center center\" class=\"divchangepho\">\n            <input type=\"file\" (change)=\"onFileChanged($event)\" accept=\"image/*\" class=\"img-input\" #fileInput>\n            <mat-icon (click)=\"fileInput.click()\">unarchive</mat-icon>\n            <a (click)=\"fileInput.click()\" id=\"changephoto\">Change photo</a>\n        </div>\n      </div>\n      <div fxLayout=\"column\">\n        <h3>Name</h3>\n        <mat-form-field>\n          <input matInput type=\"text\" placeholder={{thisname.name}} #name=\"ngModel\" name=\"inName\" ngModel [disabled]=\"disabledUser\" required>\n          <mat-error *ngIf=\"name.invalid\">You can't leave this blank</mat-error>\n        </mat-form-field>\n        <button mat-raised-button type=\"button\" color=\"lightgray\" (click)=\"changeCheck($event)\" matTooltip=\"Click to change your name\">Unlock/lock name</button>\n        <h3>E-mail</h3>\n        <mat-form-field>\n          <input matInput type=\"text\" placeholder={{thisemail.name}} ngModel #email=\"ngModel\" name=\"inMail\" ngModel [disabled]=\"disabledEmail\" required>\n          <mat-error *ngIf=\"email.invalid\">You can't leave this blank</mat-error>\n        </mat-form-field>\n        <button mat-raised-button type=\"button\" color=\"lightgray\" (click)=\"changeCheck2($event)\" matTooltip=\"Click to change your e-mail\">Unlock/lock e-mail</button>\n        <a><h4>Change password</h4></a>\n      </div>\n    </div>\n  </div>\n  <div fxLayout=\"row\" fxLayoutAlign=\"center center\">\n    <button mat-raised-button type=\"submit\" color=\"primary\">Save</button>\n  </div>\n  </form>\n</div>\n"
...
module.exports = "<div fxLayout=\"row\" fxLayoutAlign=\"center center\" id=\"first-div\">\n    <div id=\"outer-div\">\n      <div fxLayout=\"row\" fxLayoutAlign=\"center center\">\n          <h1>Create a new account</h1>\n      </div>\n      <form (submit)=\"onAddUser(userForm)\" #userForm=\"ngForm\">\n      <div id=\"inner-div\">\n            <h3>Full Name</h3>\n            <mat-form-field>\n                <input matInput type=\"text\" name=\"inName\" ngModel #name=\"ngModel\" placeholder=\"Name\" required>\n                <mat-error *ngIf=\"name.invalid\">You need to enter a name.</mat-error>\n            </mat-form-field>\n            <h3>E-mail</h3>\n            <mat-form-field>\n                <input matInput type=\"text\" name=\"inEmail\" ngModel #email=\"ngModel\" placeholder=\"E-mail\" required>\n                <mat-error *ngIf=\"email.invalid\">You need to enter a valid E-mail.</mat-error>\n            </mat-form-field>\n            <h3>Username</h3>\n            <mat-form-field>\n                <input matInput type=\"text\" name=\"inUser\" ngModel #username=\"ngModel\" placeholder=\"Username\" required minlength=\"4\" maxlength=\"15\">\n                <mat-error *ngIf=\"username.invalid\">You need to enter a valid username. Lenght: 4-15 characters.</mat-error>\n            </mat-form-field>\n            <h3>Password</h3>\n            <mat-form-field>\n                <input matInput type=\"password\" name=\"inPass\" ngModel #password=\"ngModel\" placeholder=\"Password\" required minlength=\"4\" maxlength=\"20\">\n                <mat-error *ngIf=\"password.invalid\">You need to enter a valid password. Lenght: 4-20 characters.</mat-error>\n            </mat-form-field>\n            <h3>Confirm Password</h3>\n            <mat-form-field>\n                <input matInput type=\"password\" name=\"confPass\" ngModel #password2=\"ngModel\" placeholder=\"Repeat password\" required minlength=\"4\" maxlength=\"20\">\n                <mat-error *ngIf=\"password2.invalid\">Invalid password.</mat-error>\n            </mat-form-field>\n\n            <div fxLayout=\"row\" fxLayoutAlign=\"center center\">\n                <mat-checkbox (change)=\"changeCheck($event)\" color=\"primary\"><h4>I agree to the <a href=\"/terms\">Terms of use & service</a>.</h4></mat-checkbox>\n            </div>\n\n            <button mat-raised-button [disabled]=\"disabledAgreement\" type=\"submit\">Create an account</button><p></p>\n            <a href=\"www.google.com\" id=\"google-reg\">\n              Register with   <img src=\"../../assets/img/google.png\" alt=\"google_sign-in\">\n            </a>\n            <h4>You already have an account?</h4>\n            <a routerLink=\"/start/login\" class=\"reg-link\">Log In.</a>\n      </div>\n    </form>\n    </div>\n  </div>\n"
...
/* harmony import */ var _navigation_sidenav_list_sidenav_list_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./navigation/sidenav-list/sidenav-list.component */ "./src/app/navigation/sidenav-list/sidenav-list.component.ts");
...
/* harmony import */ var _docs_docs_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./docs/docs.component */ "./src/app/docs/docs.component.ts");
...
/* harmony import */ var _error_pages_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./error-pages/not-found/not-found.component */ "./src/app/error-pages/not-found/not-found.component.ts");
...
/* harmony import */ var _navigation_app_header_app_header_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./navigation/app-header/app-header.component */ "./src/app/navigation/app-header/app-header.component.ts");
/* harmony import */ var _mainhome_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./mainhome.component */ "./src/app/mainhome.component.ts");
/* harmony import */ var _apphome_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./apphome.component */ "./src/app/apphome.component.ts");
/* harmony import */ var _navigation_app_sidenav_list_app_sidenav_list_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./navigation/app-sidenav-list/app-sidenav-list.component */ "./src/app/navigation/app-sidenav-list/app-sidenav-list.component.ts");
/* harmony import */ var _applanding_applanding_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./applanding/applanding.component */ "./src/app/applanding/applanding.component.ts");
/* harmony import */ var _newproject_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./newproject.component */ "./src/app/newproject.component.ts");
/* harmony import */ var _profile_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./profile.component */ "./src/app/profile.component.ts");
/* harmony import */ var _date_format__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./date-format */ "./src/app/date-format.ts");
/* harmony import */ var _auth_guard__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./auth.guard */ "./src/app/auth.guard.ts");
/* harmony import */ var _projects_projects_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./projects/projects.component */ "./src/app/projects/projects.component.ts");
...
AppModule.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_10__["DateAdapter"] }
];
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _docs_docs_component__WEBPACK_IMPORTED_MODULE_21__["DocsComponent"],
            _error_pages_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_24__["NotFoundComponent"],
            _navigation_app_header_app_header_component__WEBPACK_IMPORTED_MODULE_27__["AppHeaderComponent"],
            _mainhome_component__WEBPACK_IMPORTED_MODULE_28__["MainhomeComponent"],
            _apphome_component__WEBPACK_IMPORTED_MODULE_29__["ApphomeComponent"],
            _navigation_app_sidenav_list_app_sidenav_list_component__WEBPACK_IMPORTED_MODULE_30__["AppSidenavListComponent"],
            _applanding_applanding_component__WEBPACK_IMPORTED_MODULE_31__["ApplandingComponent"],
            _newproject_component__WEBPACK_IMPORTED_MODULE_32__["NewProjectComponent"],
            _profile_component__WEBPACK_IMPORTED_MODULE_33__["ProfileComponent"],
            _projects_projects_component__WEBPACK_IMPORTED_MODULE_36__["ProjectsComponent"]
        ],
        imports: [
        ...
        providers: [
            _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_7__["MatDatepickerModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_22__["FormControl"],
            { provide: _angular_material__WEBPACK_IMPORTED_MODULE_10__["DateAdapter"], useClass: _date_format__WEBPACK_IMPORTED_MODULE_34__["DateFormat"] },
            _auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]
        ],
        bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_11__["AppComponent"]],
        entryComponents: [_newproject_component__WEBPACK_IMPORTED_MODULE_32__["NewProjectComponent"], _profile_component__WEBPACK_IMPORTED_MODULE_33__["ProfileComponent"]]
    })
], AppModule);
...
let ApplandingComponent = class ApplandingComponent {
    constructor(dialog) {
        this.dialog = dialog;
    }
    ngOnInit() {
    ...
    openDialog() {
        const dialogRef = this.dialog.open(_newproject_component__WEBPACK_IMPORTED_MODULE_2__["NewProjectComponent"], {
            minWidth: '500px'
        });
...
ApplandingComponent.ctorParameters = () => [
...
class DateFormat extends _angular_material__WEBPACK_IMPORTED_MODULE_0__["NativeDateAdapter"] {
    constructor() {
        super(...arguments);
...
module.exports = "button{\n  font-size: 15px;\n  background-color: rgb(55, 106, 165);\n  color: white;\n  border-radius: 15px;\n}\n\na{\n  text-decoration: none;\n  color: white;\n}\n\nbutton:hover{\n  color: lightgray;\n  background-color: rgb(63, 118, 182);\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "p{\n  font-weight: bold;\n  font-size: 60px;\n  text-align: center;\n  color: black;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "#home-logo{\n  padding: 50px;\n  height: 25%;\n  width: 25%;\n}\n\nh1{\n  text-align: center;\n  font-size: 25px;\n  padding-left: 10%;\n  padding-right: 10%;\n}\n\nbutton{\n  background-color: rgb(55, 106, 165);\n  font-size: 20px;\n  color: white;\n  border-radius: 15px;\n}\n\np{\n  margin: 5% 20% 5% 20%;\n  text-align: center;\n}\n\n#graph{\n  height: 10%;\n  width: 10%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".layout-wrapper{\n  height: 100%;\n}\n\n.flex-wrapper{\n  height: 100%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "#outer-div{\n  border-color: black;\n  border-radius: 25px;\n  width: 40%;\n  background-color: rgba(55, 106, 165, 0.671);\n  margin: 3% 0 3% 0;\n  color: white;\n  min-width: 320px;\n  max-width: 1080px;\n}\n\n@media screen and (max-width: 600px){\n  #outer-div{\n    width: 50%;\n  }\n }\n\n#first-div{\n  background-image: url('buildings.jpg');\n  background-repeat: no-repeat;\n}\n\nh1{\n  font-size: 45px;\n}\n\nh3{\n  font-size: 22px;\n}\n\nmat-error{\n  font-size: 12px;\n}\n\nimg{\n  height: 35px;\n  width: 35px;\n  border: 15px;\n  border-color: black;\n}\n\nbutton{\n  background-color: rgb(42, 87, 138);\n  border-radius: 10px;\n  color: white;\n}\n\ndiv #inner-div{\n  align: center;\n  text-align: center;\n  margin: 3% 20% 5% 20%;\n}\n\n.forgot-a{\n  font-size: 12px;\n}\n\n.reg-link{\n  font-size: 15px;\n  text-decoration: none;\n  color: white;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let AppHeaderComponent = class AppHeaderComponent {
    ...
    openProfile() {
        const dialogRef = this.dialog.open(src_app_profile_component__WEBPACK_IMPORTED_MODULE_2__["ProfileComponent"], {
            minWidth: '500px'
        });
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
...
let AppSidenavListComponent = class AppSidenavListComponent {
    ...
    openDialog() {
        const dialogRef = this.dialog.open(src_app_newproject_component__WEBPACK_IMPORTED_MODULE_3__["NewProjectComponent"], {
            minWidth: '500px'
        });
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
    ...
    openProfile() {
        const dialogRef = this.dialog.open(src_app_profile_component__WEBPACK_IMPORTED_MODULE_4__["ProfileComponent"], {
            minWidth: '500px'
        });
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
...
AppSidenavListComponent.ctorParameters = () => [
...
module.exports = "a{\n  text-decoration: none;\n  color: white;\n}\n\na:hover, a:active{\n  color: lightgray;\n}\n\n.nav-caption{\n  display: inline;\n  padding-left: 6px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let NewProjectComponent = class NewProjectComponent {
    constructor(dialogRef, userService, projectService) {
    ...
    ngOnInit() {
        ...
        this.filteredOptions = this.myControl.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(username => this._filter(username)));
    }
    _filter(value) {
    ...
    onAddProject(form) {
        ...
        const projectname = form.value.inName;
        const projDesc = form.value.inDesc;
        const imgName = form.value.inName + '.jpg';
        // const file: File = new File(this.selectedFile, imgName, {type: 'image/jpeg'});
        // this.savenewimg.saveImg(this.selectedFile, imgName);
        const firstDate1 = form.value.inDate1;
        const lastDate = form.value.inDate2;
        ...
        this.projectService.setProject(projectname, projDesc, fixedDate, fixedlastDate, imgName);
        let thisproj;
...
module.exports = "#fulldialog{\n  min-width: 400px;\n}\n\n#user-pic{\n  height: 150px;\n  width: 150px;\n  border-radius: 100%;\n  margin-right: 20px;\n}\n\n.divchangepho{\n  margin: 15px 0px 0px -20px;\n}\n\n.img-input{\n  display: none;\n}\n\n#usernameh4{\n  margin: 0px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let ProjectsService = class ProjectsService {
    ...
    setProject(name, description, start_date, end_date, image) {
        const project = { name, description, start_date, end_date, image };
        let nameerror = false;
        this.http.post('http://192.168.1.122:3000/api/postproject', project).subscribe((responseData) => {
    ...
    getProject(name) {
        const projname = { name };
        return this.http.post('http://192.168.1.122:3000/api/lastproject', projname).toPromise();
    }
    setMember(projid, user, role) {
        const member = { projid, user, role };
        return this.http.post('http://192.168.1.122:3000/api/postmember', member).toPromise();
    }
    getUserProjects(userid) {
        const usid = { userid };
        return this.http.post('http://192.168.1.122:3000/api/userprojs', usid).toPromise();
    }
    getProjectInfo(projectid) {
        const proj = { projectid };
        return this.http.post('http://192.168.1.122:3000/api/projectinfo', proj).toPromise();
    }
};
...
module.exports = ".projpanel{\n  width: 100%;\n  height: 100%;\n  margin-top: 25px;\n}\n\n.exppanel{\n  min-width: 350px;\n  width: 70%;\n}\n\n.pantitle{\n  min-width: 100px;\n  width: 150px;\n  padding: 0% 10% 0% 3%;\n  font-weight: bold;\n}\n\n.panid{\n  padding: 0% 50% 0% 0%;\n}\n\n.openbutton{\n  width: 50px;\n  height: 40px;\n  margin: 0% 3% 0% 50%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let UserService = class UserService {
    ...
    setUser(name, email, username, password) {
        ...
        this.http.post('http://192.168.1.122:3000/api/postuser', user).subscribe((responseData) => {
            alert(responseData.message);
            if (responseData.error) {
                return;
            }
    ...
    loginUser(username, password) {
        ...
        this.http.post('http://192.168.1.122:3000/api/login', userLog).subscribe((responseData) => {
            if (responseData.error) {
                alert(responseData.message);
                return;
            }
    ...
    getUserInfo(username) {
        const user = { username };
        return this.http.post('http://192.168.1.122:3000/api/user', user).subscribe((responseData) => {
            const user1 = JSON.parse(JSON.stringify(responseData));
    ...
    getUsersM() {
        this.http.get('http://192.168.1.122:3000/api/usersquery').subscribe((responseData) => {
    ...
    updateName(username, name) {
        ...
        this.http.put('http://192.168.1.122:3000/api/nameupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
    ...
    updateMail(username, email) {
        const userupd = { username, email };
        this.http.put('http://192.168.1.122:3000/api/mailupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
                alert('Error, refresh and try again');
            }
            else {
    ...
    updateAll(username, name, email) {
        const userupd = { username, name, email };
        this.http.put('http://192.168.1.122:3000/api/allupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
                alert('Error, refresh and try again');
            }
            else {
...
module.exports = __webpack_require__(/*! C:\Users\Training\Desktop\scrum-metrics\Scrum-Metrics\src\main.ts */"./src/main.ts");
